...
<nav class="navbar navbar-expand-lg navbar-light bg-light">
    ...
    <ul class="navbar-nav mr-auto">
        <li class="nav-item ${activeNavItem eq "student" ? "active" : ""}">
            <a class="nav-link" href="${studentUrl}"><fmt:message key="student.available_courses" /><span class="sr-only">(current)</span></a>
        </li>
        <li class="nav-item ${activeNavItem eq "registeredCourses" ? "active" : ""}">
            <a class="nav-link" href="${registeredCoursesUrl}"><fmt:message key="student.registered_courses" /></a>
        </li>
        <li class="nav-item ${activeNavItem eq "coursesInProgress" ? "active" : ""}">
            <a class="nav-link" href="${coursesInProgressUrl}"><fmt:message key="student.courses_in_progress" /></a>
        </li>
        <li class="nav-item ${activeNavItem eq "completedCourses" ? "active" : ""}">
            <a class="nav-link" href="${completedCoursesUrl}"><fmt:message key="student.completed_courses" /></a>
        </li>
    </ul>
